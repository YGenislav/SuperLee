...
public abstract class DbController {
    ...
    public DbController(String tableName) {
        ...
        try {
            ...
            InputStream inputStream = DbController.class.getClassLoader().getResourceAsStream("suppliers/resources/superli.db");

            if (inputStream != null) {

                String path = DbController.class.getClassLoader().getResource("suppliers/resources/superli.db").getPath();

...
public class CLI {
    ...
    public static Union_Service_Controller serviceController;
    private static int admin_flag=0;
    static int choice;
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public static void login(){
        try {
            serviceController = Union_Service_Controller.getInstance();
        } catch (Exception e) {
            System.out.println("Error connecting to the database: " + e.getMessage());
        }
        System.out.println("Welcome !\nThis is the Supplier module which was created by Lidor and Gil.\n");
        while (true) {
            System.out.println("Please enter your username: ");
            String UserName = scanner.next();
            System.out.println("Please enter your password: ");
            String Password = scanner.next();
            if (serviceController.login(UserName, Password)) {
                System.out.println();
                System.out.println("\nWelcome " + UserName + "!");
                if (serviceController.getpermission(UserName).equals("Admin")) {
                    admin_flag=1;}
                main();
                break;
            } else {
    ...
    public static void main() {
        ...
        if (admin_flag==1) {
            ...
            while (!ExitProgram) {
                ...
                System.out.println("4. Actions related to Users Permissions.");
    ...
    public static void UserPermissionsMain() {
        boolean ExitUser_Permissions = false;
        System.out.println("\n\n~You are now in the Users Permissions Menu~\n");
        while (!ExitUser_Permissions) {

            System.out.println("What action would you like to take?");
            while (!ExitUser_Permissions) {
                System.out.println("_______________________________________________________________________ ");
                System.out.println("1. Add new user information that get permissions to this module.");
                System.out.println("2. Edit user Password");
                System.out.println("3. Delete user permissions from the system.");
                System.out.println("4. Exit From User-Permissions Menu.");
                System.out.println("_______________________________________________________________________ ");
                System.out.print("Please enter the number of your choice here: ");
                int choice = scanner.nextInt();
                System.out.println();
                switch (choice) {
                    ...
                    case 4:
                        ...
                        ExitUser_Permissions = true;
                        System.out.println("\n\n\n~You have chosen to exit from the Users Permissions menu~\n");
                        break;
                    default:
                        System.out.println("\n\n\nOops... It's seems like you entered an invalid choice number.");
                        System.out.println("Let's Try again.");
    ...
    public static void OrdersMain() {
        ...
        while (!ExitOrderMain) {
            ...
            while (!ExitOrderMain) {
                ...
                System.out.println("6. Print the last order of a specific supplier.");
                System.out.println("7. Print the entire order history of a specific supplier.");
                System.out.println("8. Print the driver details about specific order.");
                System.out.println("9. Exit From Orders Menu.");
                System.out.println("______________________________________________________________ ");
                System.out.print("Please enter the number of your choice here: ");
                int choice = scanner.nextInt();
                System.out.println();
...
// //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public static void driverDetails() {
        System.out.println("Please enter the order number you would like to print the driver details of");
        System.out.print("Please enter the number of your choice here: ");
        String ordernumber = scanner.next();
        if(!serviceController.ExistedOrderChecking(ordernumber)){
        ...
        System.out.println(serviceController.driverDetails(ordernumber));
    ...
    public static void exitdata() {
        try {
            ...
            File dbFile1 = new File(desktopFolder, "ADDS_db.db");
    ...
    public static void addUser() {
        ...
        System.out.println(serviceController.addUser(username, password, permission));
    }
    public static void EditPassword() {
        ...
        String password = scanner.next();
        System.out.println(serviceController.EditPassword(username, password));
    }
    public static void deleteUser() {
        System.out.print("Enter Username: ");
        String username = scanner.next();
        System.out.println(serviceController.deleteUser(username));
    }

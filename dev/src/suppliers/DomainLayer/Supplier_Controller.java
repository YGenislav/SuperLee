...
import suppliers.DataAccessLayer.*;
...
public class Supplier_Controller {
    ...
    private SupplierWorkersController supplierWorkersController;
    public Supplier_Controller() {
        ...
        supplierWorkersController = SupplierWorkersController.getInstance();
    }
    ...
    public String driverDetails(String orderId) {
        return supplierWorkersController.driverDetails(orderId);
    }
    ...
    public String removeOrder(Integer orderID) {
        try {
            ...
            supplierWorkersController.delete(orderID.toString());
    ...
    public String ExitSuppliers(){
        ...
        supplierWorkersController.closeConnection();
    ...
    public boolean login(String username,String password){
        return supplierWorkersController.selectUser(username,password);
    }
    public String getpermission(String username){
        return supplierWorkersController.getUserPermission(username);
    }
    public String addUser(String Username, String Password, String permission) {
        return supplierWorkersController.createUser(Username, Password, permission);
    }
    public String deleteUser(String Username) {
        return supplierWorkersController.deleteUser(Username);
    }
    public String EditPassword(String Username,String Password) {
        return supplierWorkersController.editPassword(Username, Password);
    }
    public String addOrderDriver(String orderId, String DriverId, String orderDate, String supplierId, String contactPhone) {
        ;return supplierWorkersController.addOrderDriver(orderId, DriverId, orderDate, supplierId, contactPhone);
    }
    public void deleteOrderDriver(String orderId){
        supplierWorkersController.delete(orderId);
    }
    public String getdriverid(String orderId){
        return supplierWorkersController.getdriverid(orderId);
    }

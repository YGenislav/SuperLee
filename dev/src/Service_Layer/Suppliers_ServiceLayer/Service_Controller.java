...
public class Service_Controller {
    ...
    public String driverDetails(String orderId) {
        try {
            return supplierService.driverDetails(orderId);
        } catch (Exception e) {
            return e.getMessage();
        }
    }
    ...
    public String getpermission(String Username){
        return supplierService.getpermission(Username);
    }
    public String addUser(String Username, String Password, String permission) {
        return supplierService.addUser(Username, Password, permission);
    }
    public String deleteUser(String Username) {
        return supplierService.deleteUser(Username);
    }
    public String EditPassword(String Username,String Password) {
        return supplierService.EditPassword(Username, Password);
    }
    public String addOrderDriver(String orderId, String DriverId, String orderDate, String supplierId, String contactPhone) {
        return supplierService.addOrderDriver(orderId, DriverId, orderDate, supplierId, contactPhone);
    }
